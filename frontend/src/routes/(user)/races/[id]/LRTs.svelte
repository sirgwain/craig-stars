...
<div class="flex flex-row flex-wrap justify-between gap-1">
	<button
		type="button"
		onclick={preventDefault(() => (race.lrts ^= LRT.IFE))}
	...
	<button
		type="button"
		onclick={preventDefault(() => (race.lrts ^= LRT.TT))}
	...
	<button
		type="button"
		onclick={preventDefault(() => (race.lrts ^= LRT.ARM))}
	...
	<button
		type="button"
		onclick={preventDefault(() => (race.lrts ^= LRT.ISB))}
	...
	<button
		type="button"
		onclick={preventDefault(() => (race.lrts ^= LRT.GR))}
	...
	<button
		type="button"
		onclick={preventDefault(() => (race.lrts ^= LRT.UR))}
	...
	<button
		type="button"
		onclick={preventDefault(() => (race.lrts ^= LRT.NRSE))}
	...
	<button
		type="button"
		onclick={preventDefault(() => (race.lrts ^= LRT.OBRM))}
	...
	<button
		type="button"
		onclick={preventDefault(() => (race.lrts ^= LRT.NAS))}
	...
	<button
		type="button"
		onclick={preventDefault(() => (race.lrts ^= LRT.LSP))}
	...
	<button
		type="button"
		onclick={preventDefault(() => (race.lrts ^= LRT.BET))}
	...
	<button
		type="button"
		onclick={preventDefault(() => (race.lrts ^= LRT.RS))}
	...
	<button
		type="button"
		onclick={preventDefault(() => (race.lrts ^= LRT.MA))}
	...
	<button
		type="button"
		onclick={preventDefault(() => (race.lrts ^= LRT.CE))}
