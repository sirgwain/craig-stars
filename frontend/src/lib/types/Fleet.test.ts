...
describe('Fleet test', () => {
	...
	it('returns minimal speeds for distances', () => {
		...
		expect(
			fleet.getMinimalWarp(
				player,
				{ position: {} } as MapObject,
				{ position: { x: 49 } } as MapObject,
				0,
				7
			)
		).toBe(7);
