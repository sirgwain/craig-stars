<script lang="ts">
	...
	const getDescriptionForLRT = (lrt: LRT) => {
		switch (lrt) {
			...
			case LRT.LSP:
				return 'Instead of 25000 initial population, you will start with 17500 (30% fewer). It takes a long time to overcome a lower starting population - it helps to have a high growth rate, but even then it can be painful.';
			case LRT.BET:
