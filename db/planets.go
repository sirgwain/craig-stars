...
func (c *client) FindPlanetByID(id uint64) (*game.Planet, error) {
	planet := game.Planet{}
...
func (c *client) FindPlanetByNum(gameID uint64, num int) (*game.Planet, error) {
	planet := game.Planet{}
...
func (c *client) SavePlanet(gameID uint64, planet *game.Planet) error {
