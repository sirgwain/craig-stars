...
func (c *GameConverter) csPlayerToDbPlayer(source cs.Player) Player {
	...
	dbPlayer.Players = GamePlayerIntelsToPlayerIntels(source.PlayerIntels.Players)
	dbPlayer.PlanetIntels = GamePlanetIntelsToPlanetIntels(source.PlayerIntels.Planets)
	dbPlayer.FleetIntels = GameFleetIntelsToFleetIntels(source.PlayerIntels.Fleets)
	dbPlayer.ShipDesignIntels = GameShipDesignIntelsToShipDesignIntels(source.PlayerIntels.ForeignShipDesigns)
	dbPlayer.MineralPacketIntels = GameMineralPacketIntelsToMineralPacketIntels(source.PlayerIntels.MineralPackets)
	dbPlayer.MineFieldIntels = GameMineFieldIntelsToMineFieldIntels(source.PlayerIntels.MineFields)
	dbPlayer.WormholeIntels = GameWormholeIntelsToWormholeIntels(source.PlayerIntels.Wormholes)
	dbPlayer.MysteryTraderIntels = GameMysteryTraderIntelsToMysteryTraderIntels(source.PlayerIntels.MysteryTraders)
