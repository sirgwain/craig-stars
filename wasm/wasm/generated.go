...
func GetLeftoverPointsItem(o js.Value) cs.LeftoverPointsItem {
	var obj cs.LeftoverPointsItem
	if o.IsUndefined() || o.IsNull() {
		return obj
	}
	return obj
}
func SetLeftoverPointsItem(o js.Value, obj *cs.LeftoverPointsItem) {
}
...
func GetUniverseGenerationRules(o js.Value) cs.UniverseGenerationRules {
	...
	obj.RaceLeftoverPointsPerItem = GetStringMap[map[cs.SpendLeftoverPointsOn]cs.LeftoverPointsItem](o.Get("raceLeftoverPointsPerItem"), GetLeftoverPointsItem)
...
func SetUniverseGenerationRules(o js.Value, obj *cs.UniverseGenerationRules) {
	...
	for key, value := range obj.RaceLeftoverPointsPerItem {
		valueObj := js.ValueOf(map[string]any{})
		SetLeftoverPointsItem(valueObj, &value)
		raceLeftoverPointsPerItemMap.Set(fmt.Sprintf("%v", key), valueObj)
	}
