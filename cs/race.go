...
func computeRaceSpec(race *Race, rules *Rules) RaceSpec {
	...
	spec.Costs = map[QueueItemType]Cost{
		...
		QueueItemTypeDefenses:               rules.DefenseCost.MultiplyFloat64(1 + spec.TechCostOffset.PlanetaryDefense, math.Floor),
		QueueItemTypeAutoDefenses:           rules.DefenseCost.MultiplyFloat64(1 + spec.TechCostOffset.PlanetaryDefense, math.Floor),
		QueueItemTypeTerraformEnvironment:   rules.TerraformCost.MultiplyFloat64(1 + spec.TechCostOffset.Terraforming, math.Floor),
		QueueItemTypeAutoMaxTerraform:       rules.TerraformCost.MultiplyFloat64(1 + spec.TechCostOffset.Terraforming, math.Floor),
		QueueItemTypeAutoMinTerraform:       rules.TerraformCost.MultiplyFloat64(1 + spec.TechCostOffset.Terraforming, math.Floor),
