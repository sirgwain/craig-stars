...
type Rules struct {
	...
	PopulationOvercrowdResourcePenalty float64                             `json:"populationOvercrowdResourcePenalty,omitempty"`
	PopulationOvercrowdResourceMax     float64                             `json:"populationOvercrowdResourceMax,omitempty"`
