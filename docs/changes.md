...
- Fleet fuel generation from hulls and components now happens synchronously with fuel consumption.

<!-- TODO: UNCOMMENT AFTER FIXING STUFF - Fuel usage and estimated range indicators consider ramscoop fuel generation. -->
...
- Estimated range calculations now account for ramscoop
